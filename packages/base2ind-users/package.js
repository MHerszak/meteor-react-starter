Package.describe({
  name: 'base2ind:users',
  summary: 'Base2Industries permissions.',
  version: '0.0.1',
});
...
Package.onUse(function (api) {
  ...
  api.addFiles([
    ...
    //'lib/client/templates/dashboard/users_list_roles.html',
    'lib/client/templates/dashboard/users_list_roles.js',
    //'lib/client/templates/modal/users_roles_modal.html',
