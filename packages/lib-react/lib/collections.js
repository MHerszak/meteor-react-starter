 ...
 */
Base2Ind.allowCheck = function (collection, userId, document, fieldNames, modifier) {
...
Meteor.Collection.prototype.allowCheck = function (userId, document, fieldNames, modifier) {
  Base2Ind.allowCheck(this, userId, document, fieldNames, modifier);
};

/**
 * Global schemas object. Note: not reactive, won't be updated after initialization
 * @namespace Base2Ind.schemas
 */
Base2Ind.schemas = {};
 ...
 */
SimpleSchema.prototype.getEditableFields = function (user,group)
{
  var schema = this._schema,
      fields = _.sortBy(_.filter(_.keys(schema), function (fieldName) {
    var field = schema[fieldName];
    return Users.can.editField(user, field,group);
  }), function (fieldName) {
    var field = schema[fieldName];
