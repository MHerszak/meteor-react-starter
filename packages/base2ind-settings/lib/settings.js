...
Settings.schema = new SimpleSchema({
  ...
  defaultView: {
    ...
    autoform: {
      ...
      options: function () {
        return _.map(Base2Ind.menuItems.get("viewsMenu"), function (view) {
          return {
            value: view.name,
            label: view.label()
          };
  ...
  loadMoreBehavior: {
    ...
    autoform: {
      group: "02_posts",
      options: [
        {value: 'button', label: _.partial(_i18n.t, "loadMoreButton")},
        {value: 'scroll', label: _.partial(_i18n.t, "infiniteScroll")}
      ]
    }
  },
  commentInterval: {
